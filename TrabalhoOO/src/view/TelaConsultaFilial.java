...
public class TelaConsultaFilial {
	private List<Cliente> linhas;
    private String[] colunas = new String[] {"Cidade", "Endereço"};
	private JFrame frame;
	
	public void initialize() {
		frame = new JFrame("Consulta de filial");
        ...
        JLabel txtTitulo = new JLabel("Consultar filial");
        titulo.add(txtTitulo);
        
        JPanel consulta = new JPanel();
        JLabel lblConsultaCPF = new JLabel("Digite a cidade: ");
        JTextField txtConsultaCPF = new JTextField(20);
	...
	private void voltar() {
    	frame.dispose();
    	TelaCadastroFilial v = new TelaCadastroFilial();
    	v.initialize();
    }
}